...
prompt = ChatPromptTemplate.from_messages(
    [
        ...
        ("system", "Your name is jill, you like to ask questions about whats been said. You dont summarise you're having a conversation. You don't like to ask the same questions repeatedly."),
...
def chat_endpoint():
    ...
    try:
        ...
        with open("convo.txt", "a") as f:
            ...
            f.write(f"- {user_message}\n\n\n") # Optionally log user input
            f.write(f"{FILE_PREFIX2}\n")
            f.write(f"- {initial_llm_response}\n\n\n")
        ...
        api_url = "http://127.0.0.1:5001/chat" # Assuming Flask runs on port 5000
